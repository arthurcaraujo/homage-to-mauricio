        ...
        <main>
            <figure id="img-container">
                ...
                <figcaption id="img-caption">
                    <a
                        href="https://commons.wikimedia.org/wiki/File:Maur%C3%ADcio_de_Sousa_17_Bienal_do_Livro_1.jpg"
                        target="_blank"
                    >
                        Mauricio de Sousa na 17ª Bienal do Livro, em 2015
                    </a>
                    {`. Imagem de Tânia Rêgo/ABr - `}
                    <a
                        href="https://agenciabrasil.ebc.com.br/educacao/foto/2015-09/17a-bienal-internacional-do-livro-do-rio-de-janeiro"
                        target="_blank"
                    >
                        Agência Brasil
                    </a>
                    {`, estando licenciada sob `}
                    <a
                        href="https://creativecommons.org/licenses/by/3.0/br/deed.en"
                        target="_blank"
                    >
                        CC BY 3.0 BR
                    </a>.
            ...
            <section>
                <p>
                    Maurício de Sousa se inspirava em grande parte em sua
                    família e amigos ao criar os personagens. Hoje ele é um dos
                    escritores mais famosos da literatura infantil no Brasil.
                </p>

                <p>
                    Em todos esses anos de trabalho, já foram publicadas mais
                    de 1 bilhão de revistas, tendo sido feitas exportações
                    para mais de 30 países.
                </p>

                <blockquote
                    cite="https://www2.senado.leg.br/bdsf/bitstream/handle/id/334474/noticia.htm?sequence=1"
                    tabIndex="0"
                >
                    <p>
                        "Mônica, Cascão, Cebolinha, Magali, eles todos são
                        a minha família, são inspirados na minha vida,
                        então eles são parte do que eu sou."
                    </p>
                ...
                <p id="more-info">
                    <a
                        href="https://pt.wikipedia.org/wiki/Mauricio_de_Sousa"
                        id="wikipedia-link"
                        target="_blank"
                    >
                        Clique aqui
                    </a> para saber mais sobre este artista incrível!
                </p>
            </section>
        </main>
    )
